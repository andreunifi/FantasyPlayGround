...
import 'schema/special_stats_record.dart';
...
export 'schema/special_stats_record.dart';
...
/// Functions to query SpecialStatsRecords (as a Stream and as a Future).
Future<int> querySpecialStatsRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SpecialStatsRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SpecialStatsRecord>> querySpecialStatsRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      SpecialStatsRecord.collection(parent),
      SpecialStatsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SpecialStatsRecord>> querySpecialStatsRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
